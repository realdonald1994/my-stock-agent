...
def get_stock_news(symbol):
    ...
    return response.get('feed', [])[:5]  # Get top 5 news items
...
def analyze_and_post():
    ...
    for stock in STOCKS:
        ...
        # Specialized Technical/Earnings Prompt
        prompt = f"""
    ...
    requests.post(telegram_url, data={"chat_id": TELEGRAM_CHAT_ID, "text": final_report, "parse_mode": "Markdown"})
